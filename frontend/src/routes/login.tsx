...
function Login() {
  ...
  useEffect(() => {
    ...
    if (isAuthenticated) {
      const redirectPath =
        localStorage.getItem("checklist_redirect_after_login") || "/";
  ...
  const handleGoogleLogin = (e: React.MouseEvent) => {
    ...
    // Redirect to backend auth endpoint which will redirect to Google
    const backendAuthUrl = `${BASE_URL}/auth/google`;
