...
function RouteComponent() {
    ...
    const [pendingCompletions, setPendingCompletions] = React.useState<Set<string>>(new Set())
    const timeoutRefs = React.useRef<Map<string, NodeJS.Timeout>>(new Map())

    const handleItemClick = React.useCallback((itemId: string, isComplete: boolean) => {
