...
export const useGetRecurringTemplate = (
  ...
  return useQuery({
    ...
    queryFn: () =>
      FinalRecurringTemplateAPI.GetRecurringTemplate(todoName, templateId),
...
export const useCreateRecurringTemplate = () => {
  ...
  return useMutation({
    mutationFn: ({
      ...
      FinalRecurringTemplateAPI.CreateRecurringTemplate(todo_name, template),
...
export const useDeleteRecurringTemplate = () => {
  ...
  return useMutation({
    mutationFn: ({
      ...
      FinalRecurringTemplateAPI.DeleteRecurringTemplate(todo_name, template_id),
    onSuccess: (data, variables) => {
      void queryClient.invalidateQueries({
        queryKey: ["recurring-templates", variables.todo_name],
      });
